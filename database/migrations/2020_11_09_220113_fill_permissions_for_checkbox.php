...
class FillPermissionsForCheckbox extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCheckbox constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.checkbox',
            'admin.checkbox.index',
            'admin.checkbox.create',
            'admin.checkbox.show',
            'admin.checkbox.edit',
            'admin.checkbox.delete',
            'admin.checkbox.bulk-delete',
        ]);
