...
class FillPermissionsForComparisonExperiment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComparisonExperiment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.comparison-experiment',
            'admin.comparison-experiment.index',
            'admin.comparison-experiment.create',
            'admin.comparison-experiment.show',
            'admin.comparison-experiment.edit',
            'admin.comparison-experiment.delete',
            'admin.comparison-experiment.bulk-delete',
        ]);
