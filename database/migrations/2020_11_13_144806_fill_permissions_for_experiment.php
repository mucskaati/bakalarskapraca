...
class FillPermissionsForExperiment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForExperiment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.experiment',
            'admin.experiment.index',
            'admin.experiment.create',
            'admin.experiment.show',
            'admin.experiment.edit',
            'admin.experiment.delete',
            'admin.experiment.bulk-delete',
        ]);
