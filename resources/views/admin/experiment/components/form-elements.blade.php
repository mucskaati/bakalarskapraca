<div class="row">
        ...
        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('title'), 'has-success': fields.title && fields.title.valid }">
            <label for="title" class="col-form-label" :class="isFormLocalized ? 'col-md-12' : 'col-md-12'">{{ trans('admin.experiment.columns.title') }}</label>
                ...
                <div class="form-group row align-items-center" :class="{'has-danger': errors.has('layout_id'), 'has-success': fields.layout_id && fields.layout_id.valid }">
                    <label for="layout_id" class="col-form-label" :class="isFormLocalized ? 'col-md-4' : 'col-md-12'">{{ trans('admin.experiment.columns.layout_id') }}</label>
                        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-12'">
                        <input type="text" v-model="form.layout_id" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('layout_id'), 'form-control-success': fields.layout_id && fields.layout_id.valid}" id="layout_id" name="layout_id" placeholder="{{ trans('admin.experiment.columns.layout_id') }}">
    ...
    <div class="col-12 col-md-12 text-center d-flex justify-content-center">
        <button type="submit" @click.prevent="getResponsesFromServer" class="btn btn-primary d-flex">Prejsť na 3. krok</button>
    </div>
</div>
