...
class FillPermissionsForComparison extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComparison constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.comparison',
            'admin.comparison.index',
            'admin.comparison.create',
            'admin.comparison.show',
            'admin.comparison.edit',
            'admin.comparison.delete',
            'admin.comparison.bulk-delete',
        ]);
